...
const config = {
  ...
  projectName: 'azotranscode', // Usually your repo name.
  trailingSlash: false,
  presets: [
    [
      'classic',
  ...
  themeConfig:
    ...
    ({
      navbar: {
        title: 'AzoTranscode',
        logo: {
          alt: 'Azotranscode Site Logo',
          src: 'img/logo.svg',
        },
        items: [
          {
            type: 'doc',
            docId: 'getting-started/getting-started-intro',
            position: 'left',
            label: 'Docs',
          },
          {to: '/blog', label: 'Blog', position: 'left'},
          {
            href: 'https://github.com/azorimor/azotranscode',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Azotranscode - Built with Docusaurus.`,
      },
      prism: {
